/* Environmental Datalogger v1.01
 * Initial Release 
 * Date: 15th January 2020 
 * Author: Diplodocus
 * 
 * Board: Adafruit Metro Express M0
 * Data Logger: Adafruit Data Logging Shield Rev B
 * RTC: PCF8523
 * PTH Sensor: BME280
 * Lux Sensor: TSL2591 
 * Power: 5 AA @ 1.5v (7.5v), 1500mA?
 * 
 * Script...
 * Purpose: logs environmental data (pressure, temperature, humidity, light levels (visible & infrared)
 * Collection Period: 30mins
 * Data Storage Method: SD as .csv file
 * File Size: 1440 - 1488 data point per file, new file opened every month
 * Sleep Mode: Watchdog @ 28:00 mins/secs
 * 
 * Change Log
 * v1.01 - modified watchdog timer to 28 minutes as low temperatures were causing an over count.
 */
